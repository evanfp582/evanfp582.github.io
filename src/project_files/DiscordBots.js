  ...
  return(<>
    ...
    <Box sx={paddingLeftStyle}>
      ...
      <Typography color="text.secondary" sx={bodyStyle}>
        ...
        This goes along with a group project in a private repository called Pokemon Bot where discord users could create a party of pokemon and battle eachother. <br />
      </Typography>
      ...
      <Typography color="text.secondary" sx={bodyStyle}>
        Im sure the discord SDK has only gotten better since I made this and the Pokemon Discord bot <br />
