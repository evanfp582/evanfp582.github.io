      ...
      <Grid container spacing={2} sx={{ maxWidth: "80%", textAlign: "left" }}>
        ...
        <Grid item xs={12}>
          ...
          <Typography color="text.secondary" sx={{ fontSize: "20px" }}>
            ...
            Web development, database management, AI, computer vision, low level programming, networking, developer operations, general problem solving, and learning!<br />
        ...
        <Grid item xs={12}>
          ...
          <Typography color="text.secondary" sx={{ fontSize: "20px" }}>
            ...
            I have an expansive board game collection that I love to play with friends. One of the best parts of going to college in Rochester NY, was being in close proximity to the best store of all time, <a href="https://millenniumgames.com/">Millennium Games</a>.<br />
            <span style={{ fontWeight: "bold" }}>Reading</span>:
            My library is also something I am increasingly proud of as I continue to build it up. Since the start of college, I've gotten really into reading all the classics. The Jungle by Upton Sinclair and Lord of the Rings by J.R.R. Tolkien are among my favorite books.<br />
